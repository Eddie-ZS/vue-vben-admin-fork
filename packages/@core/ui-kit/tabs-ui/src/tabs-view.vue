...
import { useForwardPropsEmits } from '@vbird-core/composables';
import { ChevronLeft, ChevronRight } from '@vbird-core/icons';
import { VbirdScrollbar } from '@vbird-core/shadcn-ui';
...
const { handleScrollAt, handleWheel, scrollbarRef, scrollDirection, scrollIsAtLeft, scrollIsAtRight, showScrollButton } =
