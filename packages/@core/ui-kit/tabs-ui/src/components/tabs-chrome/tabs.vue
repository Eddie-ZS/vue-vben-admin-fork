...
import type { TabDefinition } from '@vbird-core/typings';

import type { TabConfig, TabsProps } from '../../types';

import { computed, ref } from 'vue';

import { Pin, X } from '@vbird-core/icons';
import { VbirdContextMenu, VbirdIcon } from '@vbird-core/shadcn-ui';

interface Props extends TabsProps {}

defineOptions({
	name: 'VbirdTabsChrome',
	// // eslint-disable-next-line perfectionist/sort-objects
	inheritAttrs: false
});

const props = withDefaults(defineProps<Props>(), {
	contentClass: 'vbird-tabs-content',
	contextMenus: () => [],
	gap: 7,
	tabs: () => []
});
	...
	<div ref="contentRef" :class="contentClass" :style="style" class="tabs-chrome !flex h-full w-max overflow-y-hidden pr-6">
		<TransitionGroup name="slide-left">
			<div
				...
				<VbirdContextMenu :handler-data="tab" :menus="contextMenus" :modal="false" item-class="pr-6">
					<div class="relative size-full px-1">
						...
						<div
							...
							<VbirdIcon v-if="showIcon" :icon="tab.icon" class="mr-1 flex size-4 items-center overflow-hidden" />
