...
import type { VbirdButtonProps } from '@vbird-core/shadcn-ui';
import type { ClassType } from '@vbird-core/typings';
...
export interface ActionButtonOptions extends VbirdButtonProps {
	[key: string]: any;
	content?: string;
	show?: boolean;
}

export interface VbirdFormProps<T extends BaseFormComponentType = BaseFormComponentType>
...
export type ExtendedFormApi = FormApi & {
	useStore: <T = NoInfer<VbirdFormProps>>(selector?: (state: NoInfer<VbirdFormProps>) => T) => Readonly<Ref<T>>;
};

export interface VbirdFormAdapterOptions<T extends BaseFormComponentType = BaseFormComponentType> {
	config?: {
