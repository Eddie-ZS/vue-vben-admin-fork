...
import { useSimpleLocale } from '@vbird-core/composables';
import { VbirdExpandableArrow } from '@vbird-core/shadcn-ui';
import { cn, formatDate, isFunction, triggerWindowResize } from '@vbird-core/shared/utils';
...
<template>
	<div
		...
		<VbirdExpandableArrow v-if="rootProps.showCollapseButton" v-model:model-value="collapsed" class="ml-2">
			<span>{{ collapsed ? $t('expand') : $t('collapse') }}</span>
		</VbirdExpandableArrow>
