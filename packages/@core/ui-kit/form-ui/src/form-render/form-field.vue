...
import { FormControl, FormDescription, FormField, FormItem, FormMessage, VbirdRenderContent } from '@vbird-core/shadcn-ui';
import { cn, isFunction, isObject, isString } from '@vbird-core/shared/utils';
		...
		<FormItem
			...
			<div :class="cn('relative flex w-full items-center', wrapperClass)">
					...
					<slot
						...
						<component
							...
							<template v-for="name in renderContentKey" :key="name" #[name]>
								<VbirdRenderContent :content="customContentRender[name]" v-bind="slotProps" />
							</template>
							<!-- <slot></slot> -->
						</component>
					</slot>
				...
				<div v-if="suffix" class="ml-1">
					<VbirdRenderContent :content="suffix" />
				</div>

				<FormDescription v-if="description">
					<VbirdRenderContent :content="description" />
				</FormDescription>
