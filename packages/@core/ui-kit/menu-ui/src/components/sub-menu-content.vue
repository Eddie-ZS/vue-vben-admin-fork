...
import { ChevronDown, ChevronRight } from '@vbird-core/icons';
import { VbirdIcon } from '@vbird-core/shadcn-ui';
...
<template>
	<div :class="[b(), is('collapse-show-title', getCollapseShowTitle), is('more', isMenuMore)]">
		...
		<VbirdIcon v-if="!isMenuMore" :class="nsMenu.e('icon')" :icon="icon" fallback />
