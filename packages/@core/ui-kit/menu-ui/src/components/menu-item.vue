...
import { useNamespace } from '@vbird-core/composables';
import { VbirdIcon, VbirdTooltip } from '@vbird-core/shadcn-ui';
...
<template>
	<li
		...
		<VbirdTooltip v-if="showTooltip" :content-class="[rootMenu.theme]" side="right">
			<template #trigger>
				<div :class="[nsMenu.be('tooltip', 'trigger')]">
					<VbirdIcon :class="nsMenu.e('icon')" :icon="menuIcon" fallback />
					<slot></slot>
		...
		<div v-show="!showTooltip" :class="[e('content')]">
			...
			<VbirdIcon :class="nsMenu.e('icon')" :icon="menuIcon" />
			<slot></slot>
			<slot name="title"></slot>
		</div>
	</li>
