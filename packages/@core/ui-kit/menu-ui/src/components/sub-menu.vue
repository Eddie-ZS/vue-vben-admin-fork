...
import type { HoverCardContentProps } from '@vbird-core/shadcn-ui';
...
import { VbirdHoverCard } from '@vbird-core/shadcn-ui';
...
<template>
	<li
		...
		<template v-if="rootMenu.isMenuPopup">
			<VbirdHoverCard
				:content-class="[rootMenu.theme, nsMenu.e('popup-container'), is(rootMenu.theme, true), opened ? '' : 'hidden']"
