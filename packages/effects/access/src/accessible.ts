import type { AccessModeType, GenerateMenuAndRoutesOptions, RouteRecordRaw } from '@vbird/types';

import { cloneDeep, generateMenus, generateRoutesByBackend, generateRoutesByFrontend, mapTree } from '@vbird/utils';
