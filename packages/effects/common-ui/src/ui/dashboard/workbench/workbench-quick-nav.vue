...
import { Card, CardContent, CardHeader, CardTitle, VbirdIcon } from '@vbird-core/shadcn-ui';
		...
		<CardContent class="flex flex-wrap p-0">
			<template v-for="(item, index) in items" :key="item.title">
				<div
					...
					<VbirdIcon :color="item.color" :icon="item.icon" class="size-7 transition-all duration-300 group-hover:scale-125" />
