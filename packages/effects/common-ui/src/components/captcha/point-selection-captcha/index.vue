...
import { VbirdButton, VbirdIconButton } from '@vbird-core/shadcn-ui';
...
<template>
	<CaptchaCard
		...
		<template #extra>
			<VbirdIconButton :aria-label="$t('ui.captcha.refreshAriaLabel')" class="ml-1" @click="handleRefresh">
				<RotateCw class="size-5" />
			</VbirdIconButton>
			<VbirdButton v-if="showConfirm" :aria-label="$t('ui.captcha.confirmAriaLabel')" class="ml-2" size="sm" @click="handleConfirm">
