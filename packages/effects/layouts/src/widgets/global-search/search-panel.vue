...
import { SearchX, X } from '@vbird/icons';
import { $t } from '@vbird/locales';
import { mapTree, traverseTreeValues, uniqueByField } from '@vbird/utils';

import { VbirdIcon, VbirdScrollbar } from '@vbird-core/shadcn-ui';
import { isHttpUrl } from '@vbird-core/shared/utils';
		...
		<div class="!flex h-full justify-center px-2 sm:max-h-[450px]">
			...
			<ul v-show="searchResults.length > 0" class="w-full">
				...
				<li
					...
					<VbirdIcon :icon="item.icon" class="mr-2 size-5 flex-shrink-0" fallback />
