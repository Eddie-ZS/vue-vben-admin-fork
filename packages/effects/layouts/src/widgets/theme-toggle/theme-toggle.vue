...
import type { ThemeModeType } from '@vbird/types';

import { MoonStar, Sun, SunMoon } from '@vbird/icons';
import { $t } from '@vbird/locales';
import { preferences, updatePreferences, usePreferences } from '@vbird/preferences';

import { ToggleGroup, ToggleGroupItem, VbirdTooltip } from '@vbird-core/shadcn-ui';
...
<template>
	<div>
		<VbirdTooltip :disabled="!shouldOnHover" side="bottom">
			<template #trigger>
