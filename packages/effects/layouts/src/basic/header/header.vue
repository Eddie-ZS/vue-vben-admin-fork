...
import { RotateCw } from '@vbird/icons';
import { preferences, usePreferences } from '@vbird/preferences';
import { useAccessStore } from '@vbird/stores';

import { VbirdFullScreen, VbirdIconButton } from '@vbird-core/shadcn-ui';
	...
	<template v-for="slot in leftSlots.filter((item) => item.index < REFERENCE_VALUE)" :key="slot.name">
		<slot :name="slot.name">
			<template v-if="slot.name === 'refresh'">
				<VbirdIconButton class="my-0 mr-1 rounded-md" @click="refresh">
