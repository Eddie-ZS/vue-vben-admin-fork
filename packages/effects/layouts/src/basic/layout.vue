...
import type { MenuRecordRaw } from '@vbird/types';

import { computed, useSlots, watch } from 'vue';

import { useRefresh } from '@vbird/hooks';
...
import { cloneDeep, mapTree } from '@vbird/utils';

import { VbirdAdminLayout } from '@vbird-core/layout-ui';
import { VbirdBackTop, VbirdLogo } from '@vbird-core/shadcn-ui';
...
const { handleMenuSelect, handleMenuOpen, headerActive, headerMenus, sidebarActive, sidebarMenus, mixHeaderMenus, sidebarVisible } =
	useMixedMenu();
...
<template>
	<VbirdAdminLayout
		...
		<template #side-extra-title>
			<VbirdLogo v-if="preferences.logo.enable" :text="preferences.app.name" :theme="theme" />
		</template>
