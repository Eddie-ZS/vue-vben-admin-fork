...
import type { TabDefinition } from '@vbird/types';

import type { IContextMenuItem } from '@vbird-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@vbird/hooks';
import {
	ArrowLeftToLine,
	ArrowRightLeft,
	ArrowRightToLine,
...
import { useAccessStore, useTabbarStore } from '@vbird/stores';
import { filterTree } from '@vbird/utils';
...
export function useTabbar() {
	...
	const createContextMenus = (tab: TabDefinition) => {
		const { disabledCloseAll, disabledCloseCurrent, disabledCloseLeft, disabledCloseOther, disabledCloseRight, disabledRefresh } =
